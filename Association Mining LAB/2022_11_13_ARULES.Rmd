...
Chai Kaapi is an Indian food and beverages chain with about 19 outlets in 5 cities. Their outlets are popular "hangout" places for young and old alike. People often go to their stores for meeting their friends, family or just getting their Chai-tea or coffee. Imagine a cafe, basically.
...
[![](images/Screen%20Recording%202022-11-14%20at%207.01.11%20PM.gif)](https://www.thechaikaapi.com/)
...
```{r}
setwd("/Users/harshvardhan/Dropbox/Fall 2022/BZAN 542 TA/Association Mining/")
```
